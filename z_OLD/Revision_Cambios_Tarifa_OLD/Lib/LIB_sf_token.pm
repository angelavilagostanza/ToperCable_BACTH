...
sub ADD_Alineamiento {
	...
	$sql = "INSERT INTO topercable.alineamiento_planificado (TIPO, NOMBRE, ESTADO, num_msisdn) VALUES ('SF Cambios de Tarifa', Concat(Date_Sub(Curdate(), interval 1 day), '  - Cambios tarifa'),0,'$num_msisdn') ";
