...
my $dir_principal			= "D:\\Intranet\\Script\\ToperCable\\Analisis_Planificados\\Inventario\\LOGS\\";
...
Plogged ($log_file,$modo_ejecucion,1,"- Lanzamos CURL de analisis planificado");
